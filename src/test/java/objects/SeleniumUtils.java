...
public class SeleniumUtils {
    ...
    public WebDriver initiateDriver(String path) {
       ...
       // chromePrefs.put("plugins.always_open_pdf_externally", true);
        ...
        printSettings.put("recentDestinations", List.of(
            Map.of("id", "Save as PDF", "origin", "local", "account", "")
        ));
        printSettings.put("selectedDestinationId", "Save as PDF");
        printSettings.put("version", 2);

        chromePrefs.put("printing.print_preview_sticky_settings.appState", printSettings);
